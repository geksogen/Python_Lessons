...
def draw_score(score):
    font = pygame.font.Font('res/font.ttf', 48)
    # font = pygame.font.Font(font, 48)
    render = font.render(str(score), 1, 'green')
    render_hitbox = render.get_rect(topleft=(10, 5))
    display.blit(render, render_hitbox)

class Crosshair():
    def __init__(self):
        self.sprite = pygame.image.load('res/crosshair.png')
...
class Target():
    def __init__(self):
        ...
        self.sprite = \
            pygame.image.load('res/news-van.png')
